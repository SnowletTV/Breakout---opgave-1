...
assertEquals(new Vector(0, 7), stateBeforeBounceTop.getBalls()[0].getVelocity());
}
...
assertEquals(-4, stateBeforeBouncePaddleReplicatorHits1.getBalls()[0].getECharge());
...
assertEquals(3, facade.getEcharge(ball));
